async function apiBuilder(uuid, eventKey) {
    ...
    // window.tondi = tondi;
    // // // testing ...
    // tondi.signTransaction({tx_info:"xyz"}).then(result=>{
    //     console.log("tondi.signTransaction", result)
    // })
}
